...
<p align="center">
    <a href="https://github.com/loganmac/pocketbase/actions/workflows/release.yaml" target="_blank" rel="noopener"><img src="https://github.com/loganmac/pocketbase/actions/workflows/release.yaml/badge.svg" alt="build" /></a>
    <a href="https://github.com/loganmac/pocketbase/releases" target="_blank" rel="noopener"><img src="https://img.shields.io/github/release/pocketbase/pocketbase.svg" alt="Latest releases" /></a>
    <a href="https://pkg.go.dev/github.com/loganmac/pocketbase" target="_blank" rel="noopener"><img src="https://godoc.org/github.com/ganigeorgiev/fexpr?status.svg" alt="Go package documentation" /></a>
</p>
...
PocketBase could be [downloaded directly as a standalone app](https://github.com/loganmac/pocketbase/releases) or it could be used as a Go framework/toolkit which allows you to build
...
```sh
# go 1.18+
go get github.com/loganmac/pocketbase
```
> For Windows, you may have to use go 1.19+ due to an incorrect js mime type in the Windows Registry (see [issue#6](https://github.com/loganmac/pocketbase/issues/6)).
...
import (
    ...
    "github.com/loganmac/pocketbase"
...
- [Suggest new features and report issues](https://github.com/loganmac/pocketbase/issues)
